...
class WarehouseTransformsConcurrent{
    public static def job = { dslFactory, allVars ->
        dslFactory.job("warehouse-transforms-concurrent"){
            ...
            steps {
                virtualenv {
                    ...
                    command(
                        dslFactory.readFileFromWorkspace("dataeng/resources/warehouse-transforms-concurrent.sh")
                    )
                }
            }
        }
