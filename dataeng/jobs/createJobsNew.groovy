...
import static analytics.WarehouseTransformsConcurrent.job as WarehouseTransformsConcurrentJob
...
def taskMap = [
    ...
    WAREHOUSE_TRANSFORMS_CONCURRENT_JOB: WarehouseTransformsConcurrentJob,
]
