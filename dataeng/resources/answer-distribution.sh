...
${WORKSPACE}/analytics-configuration/automation/run-automated-task.sh \
  ...
  --include '[\"*tracking.log*20131*.gz\",\"*tracking.log*2014*.gz\",\"*tracking.log*2015*.gz\",\"*tracking.log*2016*.gz\",\"*tracking.log*2017*.gz\",\"*tracking.log*2018*.gz\",\"*tracking.log*2019*.gz\",\"*tracking.log*2020*.gz\",\"*tracking.log*2021*.gz\",\"*tracking.log*2022*.gz\"]' \
