...
class AnalyticsConstants {
    ...
    public static def common_parameters = { allVars, env=[:] ->
        return {
            ...
            stringParam('EMR_WORKER_INSTANCE_TYPE_1_CONFIG', allVars.get('EMR_WORKER_INSTANCE_TYPE_1_CONFIG'), '')
            stringParam('EMR_WORKER_INSTANCE_TYPE_2_CONFIG', allVars.get('EMR_WORKER_INSTANCE_TYPE_2_CONFIG'), '')
            textParam('EMR_HADOOP_ENV_CONFIG_PROPERTIES', allVars.get('EMR_HADOOP_ENV_CONFIG_PROPERTIES'), 'EMR Hadoop env configuration properties.')
