...
secretMap.each { jobConfigs ->
    ...
    out.println(jobConfig['public'])
    out.println(jobConfig['release'])
    out.println(jobConfig['buildScript'])
    out.println(jobConfig['gradleProperties'])
    out.println(jobConfig['keystore'])
    out.println(jobConfig['keystoreFile'])
    out.println(jobConfig['gitRepo'])
    out.println(jobConfig['gitCredential'])
    out.println(jobConfig['appBaseDir'])
    out.println(jobConfig['appBaseName'])
    out.println(jobConfig['generatedApkName'])
    out.println(jobConfig['sshAgent'])
    out.println(jobConfig['hockeyAppApiToken'])
    out.println('-------------------------------')
