...
secretMap.each { jobConfigs ->
    ...
    out.println('-------------------------------')
    out.println(jobConfig.value())
    // out.println(jobConfig.getValue('public'))
    // out.println(jobConfig.getValue('release'))
    // out.println(jobConfig.getValue('buildScript'))
    // out.println(jobConfig.getValue('gradleProperties'))
    // out.println(jobConfig.getValue('keystore'))
    // out.println(jobConfig.getValue('keystoreFile'))
    // out.println(jobConfig.getValue('gitRepo'))
    // out.println(jobConfig.getValue('gitCredential'))
    // out.println(jobConfig.getValue('appBaseDir'))
    // out.println(jobConfig.getValue('appBaseName'))
    // out.println(jobConfig.getValue('generatedApkName'))
    // out.println(jobConfig.getValue('sshAgent'))
    // out.println(jobConfig.getValue('hockeyAppApiToken'))
    out.println('-------------------------------')
