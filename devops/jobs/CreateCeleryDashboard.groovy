    ...
    public static def job = { dslFactory, extraVars ->
        ...
        extraVars.get('DEPLOYMENTS').each { deployment, configuration ->
            configuration.environments.each { environment ->
                dslFactory.job(extraVars.get("FOLDER_NAME","Monitoring") + "/create-celery-dashboard-${environment}-${deployment}") {
                    ...
                    */
                    ...
                    steps {
                        virtualenv {
                            ...
                            command(
                                dslFactory.readFileFromWorkspace("devops/resources/create_celery_dashboard.sh")
                            )
